...
function isRecordExits($lastname,$address,$state,$city,$pin)
{
    ...
    WHERE vtiger_contactdetails.lastname = ? AND vtiger_contactaddress.maillingstreet = ? AND vtiger_contactaddress.maillingcity = ? AND vtiger_contactaddress.maillingstate = ? AND vtiger_contactaddress.maillingzip = ? AND vtiger_crmentity.deleted = 0';
