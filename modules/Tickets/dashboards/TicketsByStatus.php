...
class Tickets_TicketsByStatus_Dashboard extends Vtiger_IndexAjax_View {
 
    function getSearchParams($value,$assignedto = '',$dates) {
        $listSearchParams = array();
        $conditions = array(array('tickets_status','e',decode_html(urlencode(escapeSlashes($value)))));
