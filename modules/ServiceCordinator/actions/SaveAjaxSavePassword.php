...
class ServiceCordinator_SaveAjaxSavePassword_Action extends Vtiger_IndexAjax_View {
	...
	public function savePassword(Vtiger_Request $request) {
		...
		/*if (!empty($serviceEngid)) {
			$recordModel = Vtiger_Record_Model::getInstanceById($serviceEngid, 'ServiceCordinator');
